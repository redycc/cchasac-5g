...
class FiveGEnv:
    ...
    def __init__(self, args: dict):
        ...
        self.obs_dim = self.n_rb + 4 + 3  # per-BS obs dim (always include 3 sub-goal dims)
    ...
    def _get_obs(self):
        ...
        for i in range(self.n_bs):
            ...
            obs_i = np.concatenate([sinr_norm, [load, intf_norm, tput_norm, n_ue_norm], sub_goal])
            obs_list.append(obs_i.astype(np.float32))
