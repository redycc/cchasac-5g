"""
cc-HASAC v10 — Behavioural-Cloning (BC) warm-start + encoder freeze.
...
class CCHASACv10Runner:
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "cc_hasac_v10_log.txt")
        rew_path = os.path.join(RESULTS_DIR, "cc_hasac_v10_rewards.npy")

        print(f"cc-HASAC v10 (BC pre-train + enc-freeze) | device={DEVICE} | "
        ...
        print(f"  cc-HASAC v10: {sr_z:.4f} bps/Hz  "
        ...
        np.save(os.path.join(RESULTS_DIR, "cc_hasac_v10_ablation.npy"),
