"""
cc-HASAC v8 — Behavioural-Cloning (BC) warm-start + encoder freeze.
...
class CCHASACv8Runner:
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "cc_hasac_v8_log.txt")
        rew_path = os.path.join(RESULTS_DIR, "cc_hasac_v8_rewards.npy")

        print(f"cc-HASAC v8 (BC pre-train + enc-freeze) | device={DEVICE} | "
        ...
        print(f"  cc-HASAC v8: {sr_z:.4f} bps/Hz  "
        ...
        np.save(os.path.join(RESULTS_DIR, "cc_hasac_v8_ablation.npy"),
