"""
cc-HASAC v11 — Behavioural-Cloning (BC) warm-start + encoder freeze.
...
class CCHASACv11Runner:
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "cc_hasac_v11_log.txt")
        rew_path = os.path.join(RESULTS_DIR, "cc_hasac_v11_rewards.npy")

        print(f"cc-HASAC v11 (BC pre-train + enc-freeze) | device={DEVICE} | "
        ...
        print(f"  cc-HASAC v11: {sr_z:.4f} bps/Hz  "
        ...
        np.save(os.path.join(RESULTS_DIR, "cc_hasac_v11_ablation.npy"),
