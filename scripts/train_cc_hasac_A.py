...
class CCHASACv3Runner:
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "cc_hasac_A_log.txt")
        rew_path = os.path.join(RESULTS_DIR, "cc_hasac_A_rewards.npy")
        ...
        print(f"cc-HASAC A (R1-partial, freq_sel) | device={DEVICE} | KPM={KPM_DIM} z={Z_DIM} "
