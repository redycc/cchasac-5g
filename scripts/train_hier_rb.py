...
class HierRB:
    ...
    def _save_ckpt(self, step):
        ...
        torch.save({'step': step, 'best_gput': self.best_gput,
                   ...
                   os.path.join(RESULTS_DIR, "hier_rb_best.pt"))
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "hier_rb_log.txt")
        print(f"H-RB | device={DEVICE} | MGR_OBS={MGR_OBS} WORKER_OBS={WORKER_OBS} "
        ...
        np.save(os.path.join(RESULTS_DIR, "hier_rb_ablation.npy"),
