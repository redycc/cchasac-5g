...
class CCHASACv3Runner:
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "cc_hasac_v3_log.txt")
        rew_path = os.path.join(RESULTS_DIR, "cc_hasac_v3_rewards.npy")
        ...
        print(f"cc-HASAC v3 | device={DEVICE} | KPM={KPM_DIM} z={Z_DIM} "
