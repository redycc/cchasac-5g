"""
cc-HASAC v9 — Behavioural-Cloning (BC) warm-start + encoder freeze.
...
class CCHASACv9Runner:
    ...
    def run(self):
        ...
        log_path = os.path.join(RESULTS_DIR, "cc_hasac_v9_log.txt")
        rew_path = os.path.join(RESULTS_DIR, "cc_hasac_v9_rewards.npy")

        print(f"cc-HASAC v9 (BC pre-train + enc-freeze) | device={DEVICE} | "
        ...
        print(f"  cc-HASAC v9: {sr_z:.4f} bps/Hz  "
        ...
        np.save(os.path.join(RESULTS_DIR, "cc_hasac_v9_ablation.npy"),
